...
public class Activity4 {
    ...
    public void createNewContact(){
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"First name\"]")).sendKeys("Akhila");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Last name\"]")).sendKeys("Varayogula");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Phone\"]")).sendKeys("9505360387");
        ...
        Assert.assertEquals(contactNames.get(1).getText(), "Akhila Varayogula");
    }
